        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-4 py-2 rounded-lg flex items-center gap-2 transition-colors ${
              showHistory ? 'bg-blue-500 text-white' : 'bg-gray-200 dark:bg-gray-700 hover:bg-gray-300 dark:hover:bg-gray-600 text-gray-900 dark:text-white'
            }`}
          >
            <History size={20} />
        ...
        <div className="flex gap-4 flex-wrap items-center">
          ...
          <label className="flex items-center gap-2">
            <input
              ...
              className="rounded"
            />
            <span className="text-sm text-gray-700 dark:text-gray-300">Mostrar itens sem estoque</span>
          </label>
        </div>
      </div>
      ...
      {isAddingItem && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-md transition-colors">
            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-white">Adicionar Novo Item</h3>
        ...
        <div className="overflow-x-auto">
                ...
                <tr key={id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      ...
                      <div className="text-sm text-gray-500 dark:text-gray-400 ml-2">({id})</div>
                    </div>
                  </td>
          ...
          {filteredItems.length === 0 && (
            <div className="text-center py-8">
              ...
              <h3 className="mt-2 text-sm font-medium text-gray-900 dark:text-white">Nenhum item encontrado</h3>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow transition-colors">
          ...
          <div className="max-h-96 overflow-y-auto">
            {(inventario.historico_transacoes || [])
              ...
              .map((transaction) => (
                <div key={transaction.id} className="p-4 border-b border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                  <div className="flex items-center gap-3">
                    <div className="flex-shrink-0">
                      {transaction.tipo === 'adicionar' ? (
                        <Plus className="text-green-500 dark:text-green-400" size={20} />
                      ) : (
                        <Minus className="text-red-500 dark:text-red-400" size={20} />
                      )}
                    </div>
                    <div className="flex-1">
                      <div className="flex items-center gap-2">
                        <span className="font-medium text-gray-900 dark:text-white">{transaction.autor}</span>
                        ...
                        <span className="font-medium text-gray-900 dark:text-white">{transaction.nome_item}</span>
                      </div>
            ...
            {(!inventario.historico_transacoes || inventario.historico_transacoes.length === 0) && (
              <div className="text-center py-8">
                ...
                <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">As transações aparecerão aqui.</p>
              </div>
            )}
          </div>
        </div>
