    ...
    <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-lg">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Rankings dos Trabalhadores</h1>
            <p className="text-gray-600">Performance baseada em atividades registradas</p>
          </div>
        </div>
      ...
      {viewMode === 'weekly' && (
        <div className="mt-6 pt-6 border-t border-gray-200">
          <div className="bg-gradient-to-r from-yellow-50 to-orange-50 border border-yellow-200 rounded-lg p-4 mb-4">
            <h3 className="font-semibold text-yellow-800 mb-2">🏆 Premiação Semanal - Top 3 Plantação</h3>
            <div className="grid grid-cols-3 gap-4 text-center">
              ...
              <div>
                <div className="text-2xl">🥈</div>
                <div className="font-bold text-gray-600">R$ 1.500</div>
      ...
      {rankings && (
        <div className="grid grid-cols-3 gap-4 mt-6 pt-6 border-t border-gray-200">
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600">Trabalhadores - Plantas</div>
          </div>
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600">Trabalhadores - Animais</div>
          </div>
          <div className="text-center">
            ...
            <div className="text-sm text-gray-600">Trabalhadores - Ferrovia</div>
          </div>
        </div>
      )}
    </div>
