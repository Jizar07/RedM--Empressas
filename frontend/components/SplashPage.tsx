...
interface SplashPageProps {
  ...
  onShowAddBotInstructions?: () => void;
}

export default function SplashPage({ botStats, onShowAddBotInstructions }: SplashPageProps) {
  const handleLogin = () => {
  ...
  const handleAddBot = () => {
    if (onShowAddBotInstructions) {
      onShowAddBotInstructions();
    }
  };
          ...
          <div className="mb-16">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button
                ...
                className="inline-flex items-center px-8 py-4 text-lg font-medium text-white bg-red-600 hover:bg-red-700 rounded-lg transition-colors shadow-lg hover:shadow-xl"
              >
              ...
              <button
                onClick={handleLogin}
                className="inline-flex items-center px-8 py-4 text-lg font-medium text-indigo-600 bg-white hover:bg-gray-100 rounded-lg transition-colors shadow-lg hover:shadow-xl"
              >
